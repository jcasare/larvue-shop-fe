<template>
  <div class="flex min-h-screen flex-col items-center justify-center bg-gray-100 px-4 dark:bg-gray-900">
    <p class="text-7xl font-bold text-indigo-600 sm:text-9xl">404</p>
    ...
    <router-link
      to="/dashboard"
      class="mt-8 rounded-lg bg-indigo-600 px-5 py-2.5 text-sm font-medium text-white hover:bg-indigo-700 transition-colors"
    >
      Go back home
    </router-link>
  </div>
